    ...
    <>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-6xl mx-auto px-6">
          <h1 className="text-4xl font-bold text-center mb-6 bg-gradient-to-r from-blue-500 to-cyan-500 bg-clip-text text-transparent" data-aos="fade-up">
            All Projects
          </h1>
          <p className="text-center text-gray-600 mb-16 text-lg max-w-2xl mx-auto" data-aos="fade-up" data-aos-delay="100">
            Here are all my projects that showcase my skills and passion for web development
          </p>
